...
<html lang="en">
 <head>
	...
	<link rel="stylesheet" href="eventsContentTeacher.css">
...
<header>
  ...
  <div class="wrapper">
	...
	<?php
		...
		//$result = $mysqli->query("SELECT * FROM event") or die($mysqli->error);
		//pre_r($result);
	?>
	...
	<?php while($row=$result->fetch_assoc()): ?>
				<tr>
					...
					<td>
						<a href="eventsContentTeacher.php?edit=<?php echo $row['event_id']; ?>" class="btn-info">Edit</a>
						<a href="eventsContentTeacher.php?delete=<?php echo $row['event_id']; ?>" onClick="deleteSuccess()" class="btn-danger">Delete</a>
					</td>
				</tr>
	<?php endwhile; ?>
		</table>
  ...
  <div>
		<h2 style="text-align: center;background-color: #cfe2cf;color: #09092a;padding: 5px 0px 5px 0px;margin-top: 10px;">Manage Event Here</h2>
	</div>
	...
	<form action="process.php" method="POST">
		...
		<div class="form-group">
			...
			<input type="text" name="location" class="form-control" value="<?php echo $location; ?>" placeholder="Enter event location">
		</div>
		<div class="form-group">
			<label>Date</label><br>

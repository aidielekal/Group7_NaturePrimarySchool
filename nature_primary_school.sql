...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2021 at 09:05 AM
...
--
-- Database: `nature_primary_school`
--
...
INSERT INTO `studentmarks` (`studentID`, `Student_Name`, `English_Studies`, `Mathematics`, `Basic_Science_Technology`, `Social_Studies`, `Civic_Education`, `Cultural_Creative_Arts`, `Physical_Health_Education`, `Geography`, `Islamic_Studies`, `Visual_Arts`, `GPA`) VALUES
...
INSERT INTO `user` (`userID`, `Name`, `DOB`, `Username`, `Password`, `Address`, `City`, `Zipcode`, `State`, `ContactNumber`, `userType`) VALUES
...
--
ALTER TABLE `studentmarks`
  ADD CONSTRAINT `studentmarks_ibfk_1` FOREIGN KEY (`studentID`) REFERENCES `user` (`userID`);
COMMIT;
